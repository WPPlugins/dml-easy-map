...
Plugin URI: https://srd.wordpress.org/plugins/dml-easy-map/
...
Version: 1.5.1
Author: Ozkan ARDIL
Author URI: http://googlemap.webmountain.net/wordpress/index.php
License: GPL2
...
function dml_create_map($url, $apicode) {
	...
	try {
		...
		if( $map_id ):
			...
			add_post_meta( $map_id, 'dml_layers', '0_0_0' );
		endif;
...
function dml_Save_Polygon_Settings(){
	...
	if ( isset( $dml_page_link ) && isset( $dml_post_id ) && isset( $dml_field1 ) && isset( $dml_value1 ) && isset( $dml_field2 ) && isset( $dml_value2 ) && isset( $dml_field3 ) && isset( $dml_value3 ) && isset( $dml_field4 ) && isset( $dml_value4 ) && isset( $dml_field5 ) && isset( $dml_value5 ) && isset( $dml_field6 ) && isset( $dml_value6 ) && isset( $dml_field7 ) && isset( $dml_value7 ) && isset( $dml_field_num ) ) {
		try {
			$iconData = array(
				'dml_post_id' => $dml_post_id,
				'dml_field1' => $dml_field1,
...
function dml_dashboard_admin_page() {
	...
	$output = '
		<div class="wrap">
			...
			<p>Build Google Maps for pages and posts. You will find the active map list attached below. Firstly, add a short code on a page or post, then select the map from the list. <br />
			<a href="http://googlemap.webmountain.net/wordpress/index.php#contact" target="blank">Contact</a> | <a href="https://srd.wordpress.org/plugins/dml-easy-map/" target="blank">Plugin page</a> | <a href="https://codecanyon.net/item/dml-easy-google-map-plugin/19225851" target="blank">BUY PRO Version</a>
			</p> 
